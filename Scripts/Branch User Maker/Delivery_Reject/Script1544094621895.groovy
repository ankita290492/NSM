...
WebUI.click(findTestObject('Object Repository/Delivery_Confirm/Page_Delivery Confirmation/button_Reject'))

WebUI.acceptAlert()

WebUI.setText(findTestObject('Object Repository/Delivery_Confirm/Page_Delivery Confirmation/textarea_Reject Reason_rejectr'), 
    'Reject Flow')
