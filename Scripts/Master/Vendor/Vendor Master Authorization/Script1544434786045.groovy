...
WebUI.click(findTestObject('Object Repository/Master/Vendor master/Page_Bank Dashboard/a_Vendor Master (1)'))

WebUI.click(findTestObject('Object Repository/Master/Vendor master/Page_Vendor Master/button_Authorize'))
...
WebUI.click(findTestObject('Master/Vendor master/Page_Vendor Master/button_Authorize'))

CustomKeywords.'com.reusableComponents.HighlightElement.run'(findTestObject('Object Repository/Master/Vendor master/Page_Vendor Master/div_Record Authorized successf'))
...
WebUI.setText(findTestObject('Object Repository/Master/Vendor master/Page_Vendor Master/textarea__description (1)'), 'K update vendor')
