...
/*WebUI.click(findTestObject('Object Repository/Master/Branch Master/Page_Branch Master/button_Authorize'))
WebUI.acceptAlert()*/
...
CustomKeywords.'com.reusableComponents.HighlightElement.run'(findTestObject('Object Repository/Master/Branch Master/Page_Branch Master/div_Record Authorized successf'))
