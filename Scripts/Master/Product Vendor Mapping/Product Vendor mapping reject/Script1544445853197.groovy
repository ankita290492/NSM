...
WebUI.click(findTestObject('Object Repository/Master/Product vendor mapping/Page_Product Vendor Mapping Master/button_Reject'))
...
WebUI.click(findTestObject('Object Repository/Master/Product vendor mapping/Page_Product Vendor Mapping Master/button_Reject'))
WebUI.acceptAlert()
WebUI.setText(findTestObject('Object Repository/Master/Product vendor mapping/Page_Product Master/textarea__rejectReason'),
	'Test Reject Flow')
...
CustomKeywords.'com.reusableComponents.HighlightElement.run'(findTestObject('Object Repository/Master/Product vendor mapping/Page_Product Vendor Mapping Master/select_ACTIVE INACTIVE'))
