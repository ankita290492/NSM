...
WebUI.click(findTestObject('Object Repository/Master/Service Category/Page_Service Category Master/button_Authorize'))

WebUI.click(findTestObject('Object Repository/Master/Service Category/Page_Service Category Master/input_Reject_btnclear'))

WebUI.click(findTestObject('Object Repository/Master/Service Category/Page_Service Category Master/input_Reject_btnclose'))
