...
WebUI.click(findTestObject('Object Repository/Master/Product service category mapping/Page_Product Service Category Mappi/button_Authorize'))
...
WebUI.setText(findTestObject('Object Repository/Master/Product service category mapping/Page_Search/input_Product Name_Product Nam'), 
    'product1')

WebUI.click(findTestObject('Object Repository/Master/Product service category mapping/Page_Search/input (1)'))

WebUI.click(findTestObject('Object Repository/Master/Product service category mapping/Page_Search/td_PRODUCT1'))
