...
WebUI.setText(findTestObject('Object Repository/Request_initiate/Page_Login Page/input_Vendor platform_userid'), GlobalVariable.CrName)

WebUI.setEncryptedText(findTestObject('Object Repository/Request_initiate/Page_Login Page/input_Vendor platform_password'), 
    GlobalVariable.CrPwd)
...
WebUI.callTestCase(findTestCase('Circle User/Authorize Request'), [:], FailureHandling.CONTINUE_ON_FAILURE)
